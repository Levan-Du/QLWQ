...
var goods = arr.map(function (el, i) {
    var istr = '00' + el;
    return {
        name: '物品名称' + i,
        ImgUrl: __webpack_require__(87)("./good-" + istr.substring(istr.length - 2, istr.length) + '.jpg'),
        Price: 15,
        type: i % 2 + 1,
        Unit: '积分'
    };
...
var _pay = __webpack_require__(11);
...
var renderExchangeByDiamondGrid = function renderExchangeByDiamondGrid(state) {
    var tmplArr = [],
        d = state.data,
        l = d.length,
        items = '',
        setVisible = function setVisible(i, l) {
        if (l <= PageSize0) {
            return ' visible';
        } else {
            if (i === PageSize0 - 1) {
...
var initDiamondGridPagerAction = function initDiamondGridPagerAction() {
