...
$.extend({
    showLoginModal: function showLoginModal(option) {
        ...
        var code = randomChar(4),
            ...
            $submit_id = '#' + submit_id,
            logoiconUrl = __webpack_require__(10),
...
exports.default = function (type, moveBoxs, index, currIndex, cb) {
    ...
    currGrid.animate({ left: currLeft, opacity: .5 }, 300, 'swing', function () {
        cb && cb();
    });
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
