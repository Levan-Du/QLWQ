...
$.extend({
    showLoginModal: function showLoginModal(option) {
        ...
        var code = randomChar(4),
            ...
            $submit_id = '#' + submit_id,
            logoiconUrl = __webpack_require__(11),
        ...
        var loadValidateImg = function loadValidateImg() {
            ...
            validCodeCheck = function validCodeCheck(code) {
        ...
        $($valicode_id).change(function (e) {
            var code = $(e.currentTarget).val();
            validCodeCheck(code);
        });

        $($valicode_id).blur(function (e) {
            var code = $(e.currentTarget).val();
            validCodeCheck(code);
        });
        ...
        $($form_id).submit(function (e) {
            ...
            dd.Post('/Login/AccountLogon', data, function (res) {
                if (res.status !== 'success') {
