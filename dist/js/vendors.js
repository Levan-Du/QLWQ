...
exports.paramsToJson = exports.jsonToParams = exports.dd = exports.randomChar = exports.getBoxSize$ = exports.getBoxSize = exports.htmlDecode = exports.htmlEncode = exports.clearCookie = exports.setCookie = exports.getCookie = exports.getQueryString = undefined;

var _WxHelper = __webpack_require__(36);
...
var paramsToJson = exports.paramsToJson = function paramsToJson(params) {
    var o = {},
        r = params.split('&');
...
$.extend({
    showLoginModal: function showLoginModal(option) {
        ...
        var code = randomChar(4),
            ...
            logoiconUrl = __webpack_require__(9),
        ...
        var loadValidateImg = function loadValidateImg() {
            ...
            errorBox.fadeIn('normal', function () {});
        },
            ...
            validCodeCheck = function validCodeCheck(code, callback) {
            dd.Post('/Login/CheckValidaeImage', 'valicode=' + code, function (res) {
        ...
        $($form_id).submit(function (e) {
            ...
            validCodeCheck($($valicode_id).val(), function () {
        ...
        $($btn_wx_id).click(function (e) {
            $($modal_id + ' .modal-wx').addClass('visible');
            var url = (0, _WxHelper.GetCodeUrl)();
            console.log(url);
...
exports.initLoginUserAction = exports.loadLoginInfo = exports.wxLogin = undefined;

var _common = __webpack_require__(1);

var wxLogin = exports.wxLogin = function wxLogin(cb) {
    var code = (0, _common.getQueryString)()['code'];
    if (code) {
        _common.dd.Post('/Login/userinfo', 'code=' + code, function (res) {
            console.log(res);
            if (res.status === 'success') {
                (0, _common.setCookie)('account', res.message.account);
                cb && cb();
            } else {
                alert(res.message);
            }
...
var loadLoginInfo = exports.loadLoginInfo = function loadLoginInfo(cb) {
    var account = (0, _common.getCookie)('account'),
        qs = 'account=' + account;
    ...
    _common.dd.Get('/Login/AccountInfo', qs, function (res) {
        if (res.status === 'success') {
            var u = res.message[0];
...
var initLoginUserAction = exports.initLoginUserAction = function initLoginUserAction() {
    ...
    exitEle.click(function (e) {
        ...
        window.location.reload();
        _common.dd.Post('/Login/Logout', null, function (res) {});
    });
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getGenderDes = exports.getGenderDes = function getGenderDes(gender) {
...
var initTab = exports.initTab = function initTab() {
    $('.tab-title').mouseenter(function (e) {
        var target = $(e.currentTarget),
...
var initNav = exports.initNav = function initNav(page) {
    if (!page) {
        return;
    }
    ...
    var navItems = ['index', 'news', 'games', 'mall', 'user'],
        ...
        tmpl = navItems.map(function (el, i) {
...
var getPageTitle = exports.getPageTitle = function getPageTitle(item) {
    switch (item) {
        case 'index':
            return '首页';
        case 'news':
...
var initNavAction = exports.initNavAction = function initNavAction() {
    ...
    navItems.mouseenter(function (e) {
        ...
        subMenu.stop();
        subMenu.show();
        subMenu.animate({ height: '150px' }, 300, 'swing', function () {});
    });
...
var Get = function Get(url, succFunc) {
...
var GetCodeUrl = exports.GetCodeUrl = function GetCodeUrl() {
    return wx_code_url.replace('#APPID#', APP_ID).replace('#REDIRECT_URI#', encodeURIComponent(REDIRECT_URI)).replace('#RESPONSE_TYPE#', 'code').replace('#SCOPE#', 'snsapi_login').replace('#STATE#', 'qywl');
};

var GetToken = exports.GetToken = function GetToken(code, cb) {
    var url = wx_token_url.replace('#APPID#', APP_ID).replace('#SECRET#', APP_SECRET).replace('#CODE#', code).replace('#GRANT_TYPE#', 'authorization_code');
    Get(url, function (res) {});
};

var LoadRefreshToken = exports.LoadRefreshToken = function LoadRefreshToken() {
    REFRESH_TOKEN = '';
};

var RefreshToken = exports.RefreshToken = function RefreshToken() {
    var url = wx_refreshtoken_url.replace('#APPID#', APP_ID).replace('#GRANT_TYPE#', 'refresh_token').replace('#REFRESH_TOKEN#', REFRESH_TOKEN);
    Get(url, function (res) {});
};

var GetWxUserInfo = exports.GetWxUserInfo = function GetWxUserInfo(access_token) {
    var url = wx_refreshtoken_url.replace('#ACCESS_TOKEN#', access_token).replace('#SCOPE#', 'snsapi_base').replace('#OPENID#', OPENID);
    Get(url, function (res) {});
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
exports.default = function (type, moveBoxs, iTarget, currIndex, preIndex, cb) {
    ...
    currGrid.animate({ left: 0 }, 300, 'swing', function () {
        aniComplete1 = true;
        if (aniComplete2) {
            cb && cb();
        }
    });
    preGrid.animate({ left: preLeft }, 300, 'swing', function () {
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/svg+xml;base64,"
